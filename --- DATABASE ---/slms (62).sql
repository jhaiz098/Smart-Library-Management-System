...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2026 at 01:25 PM
...
(11, 1, 'asdasd', 'asdasdasdasd', 'asdasdadasd', '2026', 'asd', 'active', 'borrowed', '2026-06-02 17:17:08', '2026-06-05 08:24:44');
...
(39, 95, 4, 11, 'BRW-2026-000039', '2026-06-05 16:24:44', '2026-06-20 23:59:59', NULL, 'borrowed', 1, 0, 'Book marked as claimed successfully by Admin.', '2026-06-05 08:24:44', '2026-06-05 08:24:44');
...
(25, 2, 11, '2026-06-05 16:25:10', NULL, 'pending', NULL, NULL, 'Book reserved successfully.', '2026-06-05 08:25:10', '2026-06-05 08:25:10'),
...
CREATE TABLE `role_permissions` (
  ...
  `can_manage_returns` tinyint(4) NOT NULL,
  `can_manage_fines` tinyint(4) NOT NULL,
  `can_manage_settings` tinyint(4) NOT NULL,
  `can_manage_categories` tinyint(4) NOT NULL,
  `can_manage_roles_permissions` tinyint(4) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `role_permissions` (`id`, `role_id`, `staff_level_id`, `can_manage_users`, `can_manage_books`, `can_manage_borrowed_books`, `can_manage_borrow_requests`, `can_manage_returns`, `can_manage_fines`, `can_manage_settings`, `can_manage_categories`, `can_manage_roles_permissions`, `created_at`, `updated_at`) VALUES
(2, 2, 4, 1, 1, 1, 1, 1, 1, 1, 1, 1, NULL, '2026-06-05 11:11:23'),
(3, 2, 1, 0, 1, 0, 1, 1, 1, 1, 1, 1, NULL, '2026-06-05 11:11:37'),
(4, 2, 2, 0, 1, 1, 1, 1, 1, 1, 1, 1, NULL, '2026-06-05 10:56:34');
...
(7, 'LIB-2026-4C9587', 1, 'Wakawaka', 'wakawaka@gmail.com', '09310241773', '$2y$10$1ABnfoUxl15aQ9BR17yo0u8W3oqdYteUqvE.4ZGXoXoGErweceqWq', 2, 'activated', 1, '2026-06-02 05:09:18', '2026-06-05 09:33:58'),
